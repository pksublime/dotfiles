...
# Sourced (not fpath) on purpose: oh-my-zsh/p10k drop custom fpath entries by
# the time completions autoload, so compdef here is the reliable hook.
[[ -f ~/.gl-completion.zsh ]] && source ~/.gl-completion.zsh
