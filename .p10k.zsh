# Generated by Powerlevel10k configuration wizard on 2025-06-10 at 14:39 PDT.
...
() {
  ...
  # Default prompt symbol - shows warning when root.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$([ "$EUID" = "0" ] && echo "🚨" || echo "❯")'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='$([ "$EUID" = "0" ] && echo "🚨" || echo "❮")'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='$([ "$EUID" = "0" ] && echo "🚨" || echo "V")'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION='$([ "$EUID" = "0" ] && echo "🚨" || echo "▶")'
